...
| 优先级 | 区域 | 建议 |
| --- | --- | --- |
| P1 | 安全测试 | `NetworkSafety`、WebView2/RSS 资源策略、RSS XML 安全、RSS URL/redirect scheme/hop 上限、通知 activation parser 和更多邮件 sanitizer 边界已有测试；继续增加 sanitizer 畸形/大型恶意输入和集成型 private-host 测试。 |
